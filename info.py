...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001911817898 1002694399477 -1001521000125').split()]  # Channel id for auto indexing (make sure bot is admin)
