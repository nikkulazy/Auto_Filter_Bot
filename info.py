...
ULTRA_FAST_MODE = bool(environ.get('ULTRA_FAST_MODE', True))
#Making it false will not save caption in db SO you can save some storage space


PICS = (environ.get('PICS', 'https://envs.sh/_YL.jpg https://envs.sh/Hjn.jpg https://envs.sh/Hjp.jpg https://envs.sh/gAN.jpg')).split()  # Sample pic
NOR_IMG = environ.get("NOR_IMG", "https://graph.org/file/e20b5fdaf217252964202.jpg")
MELCOW_PHOTO = environ.get("MELCOW_PHOTO", "https://graph.org/file/56b5deb73f3b132e2bb73.jpg")
SPELL_IMG = environ.get("SPELL_IMG", "https://graph.org/file/13702ae26fb05df52667c.jpg")
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://i.ibb.co/kWtBcgx/photo-2025-08-04-09-11-58-7534655638404595732.jpg'))
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1383239349').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001911817898 1002694399477').split()]  # Channel id for auto indexing (make sure bot is admin)

LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001521000125'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002016227618'))  # Bin channel id (make sure bot is admin)
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002229751777'))  # Premium logs channel id
...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001521000125')  # Request channel id (make sure bot is admin)
...
auth_channels     = environ.get("AUTH_CHANNELS", "-1002072782451")# Channels for force sub (make sure bot is admin)

# ============================
# Payment Configuration
# ============================
QR_CODE = environ.get('QR_CODE', 'https://i.ibb.co/kWtBcgx/photo-2025-08-04-09-11-58-7534655638404595732.jpg')    # QR code image for payments
...
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://Wolverine:Woiverine7079@cluster0.olnlt9q.mongodb.net/?retryWrites=true&w=majority")  # MongoDB URI for the second database (if MULTIPLE_DB is True)
# ============================
# Movie Notification & Update Settings
# ============================
MOVIE_UPDATE_NOTIFICATION = bool(environ.get('MOVIE_UPDATE_NOTIFICATION', True))  # Notification On (True) / Off (False)
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002072782451'))  # Notification of sent to your channel
...
TUTORIAL = environ.get("TUTORIAL", "https://t.me/wolverine273")   # Tutorial link for verification
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/wolverine273")   # Second tutorial link for verification
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/wolverine273")   # Third tutorial link for verification
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/thinkfilmy') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/WOLVERIN_P') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/Fliestoras_bot') # Update channel link for the bot
...
DELETE_TIME = int(environ.get("DELETE_TIME", "240"))  #  deletion time in seconds (default: 5 minutes). Adjust as per your needs.
