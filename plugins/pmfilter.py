...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
                    ...
                    InlineKeyboardButton('Mᴏᴠɪᴇ Gᴜɪᴅᴇ', url=f'http://t.me/wolverine273_bot/myapp'),
        ...
        buttons = [[
            InlineKeyboardButton('📞Contect Owner',url=f"https://t.me/WOLVERIN_P"),
        ],[
        ...
        buttons = [[
            ...
            InlineKeyboardButton ('ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴᴀʟꜱ  🎀',url=f"https://t.me/wolverine273"), 
        ],[
            InlineKeyboardButton('⇋ ʙᴀᴄᴋ ᴛᴏ ʜᴏᴍᴇ ⇋', callback_data='start')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
...
async def auto_filter(client, msg, spoll=False):
    ...
    if imdb:
        ...
        if settings.get('button'):
            cap = f"<b>🧾 <u>Your Requested Files Are Here</u> 👇 \n</b>"
        else:
            cap = f"<b>🧾 <u>Your Requested Files Are Here</u> 👇 \n</b>"
