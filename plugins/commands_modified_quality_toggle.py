            ...
            for file in files:
                ...
                if QUALITY_LIMIT and not is_premium:
                    if not any(q in (files1.file_name or "").lower() for q in FREE_QUALITIES):
                        buttons = [[
                            ...
                            InlineKeyboardButton('🔞 𝙼𝙰𝚂𝚃𝙸 𝚃𝙸𝙼𝙴 📌', url=UPDATE_CHNL_LNK)
                        ]]
                        reply_markup = InlineKeyboardMarkup(buttons)
                        await message.reply_photo(
                ...
                if STREAM_MODE and not PREMIUM_STREAM_MODE:
                    ...
                    btn = [
                        ...
                        [InlineKeyboardButton('ℹ️ ᴠɪᴇᴡ ᴀᴜᴅɪᴏ & ꜱᴜʙꜱ ɪɴꜰᴏ ℹ️', callback_data=f'extract_data')],
                    ...
                    btn = [[InlineKeyboardButton('🔞 𝙼𝙰𝚂𝚃𝙸 𝚃𝙸𝙼𝙴 📌', url=UPDATE_CHNL_LNK)]]
